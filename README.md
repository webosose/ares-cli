...
> [!WARNING]
> **We moved to [@webos-sdk/cli](https://github.com/webos-sdk/cli).**
In the future, we plan to develop and maintain a single webOS CLI to support multi webOS in @webos-sdk/cli.
This repository has been deprecated since March 4, 2024.
