...
(function() {
    ...
    const installer = {
                ...
                function(next) {
                    ...
                    async.waterfall([
                        ...
                        function() {
                            ...
                            log.silly("installer#install()", "srcMd5:", srcMd5);
                            next();
                        }
                    ], function(err) {
                        next(err);
                ...
                function(next) {
                    ...
                    function _onData(data) {
                        ...
                        if (str) {
                            ...
                            log.silly("installer#install()", "dstMd5:", dstMd5);
                        }
                        if (!dstMd5) {
                ...
                function(next) {
                    ...
                    function _appinstalld(next) {
                        ...
                        luna.send(options, addr, param, function(lineObj, next) {
                            log.silly("installer#install()", "lineObj: %j", lineObj);
            ...
            async.waterfall([
                ...
                function(next) {
                    ...
                    function _appinstalld(next) {
                        ...
                        luna.send(options, addr, param, function(lineObj, next) {
                            log.silly("installer#remove()", "lineObj: %j", lineObj);
                            let resultValue = lineObj;
                ...
                log.silly("installer#remove()", "err:", err, ", result:", result);
                if (!err) {
        ...
        list: function(options, next) {
            ...
            async.series([
                ...
                log.silly("installer#list()", "err:", err, ", results:", results[3]);
                next(err, results[3]);
            });
        }
    };
    ...
    function makeSession(options, next){
        log.info("installer#makeSession()", (options.session ? "already session connected" : "need to make new session"));
        if (!options.session) {
