...
(function () {
    ...
    function copyFilesToDst(session, src, dst, dstType, options, next) {
        log.verbose("Puser#copyFilesToDir()","src:", src, ", dst:", dst);
        const self = this;
        ...
        async.waterfall([
            ...
            function(stats, next) {
                if (stats.isDirectory()) {
                    log.verbose("Puser#copyFilesToDir()", "src is a directory");
                    ...
                    mkDir(session, dst, function(err) {
                        log.verbose("Puser#copyFilesToDir()", "mkDir#dst:", dst, ", err:", err);
