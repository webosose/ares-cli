    ...
    Packager.prototype = {
        ...
        analyzeIPK: function(options, next) {
            ...
            function _checkTmpDir(next) {
                log.info("package#analyzeIPK()#_checkTmpDir()", "tmpDirPath: ", tmpDirPath);
            ...
            function _unpackTar(next) {
                ...
                if (fs.existsSync(path.resolve(tmpDirPath, "control.tar.gz"))) {
                    ...
                    return next(errHndl.getErrMsg("NO_COMPONENTFILE", ", control tar file"));
                }
                ...
                if (fs.existsSync(path.resolve(tmpDirPath, "data.tar.gz"))) {
                    ...
                    return next(errHndl.getErrMsg("NO_COMPONENTFILE", "data tar file"));
                }
            }
                ...
                ipkConfig.webOSMetaFiles.forEach(function(item){
                    ...
                    if (item === "control") {
                        ...
                        if (!fs.existsSync(targetFile)) {
                            return next(errHndl.getErrMsg("NO_COMPONENTFILE", "control file"));
                        }
