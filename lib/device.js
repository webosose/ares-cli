...
(function() {
    ...
    const device = {
        ...
        resourceList: function(options, next) {
            ...
            // resource-monitor --list, get external app & service resource usage
            async.series([
                _makeSession,
                _getProcessList
            ],  function(err, results) {
            ...
            function __setProcessInfo(processData) {
                ...
                try{
                    ...
                    if(appStartIndex < 0){
                        // TODO : there is no external app, handling corner case
                    ...
                    try{
                        ...
                        //__setProcessInfo(function(){});
                        console.log("asdfasdfasdf error!!!" + e);
                        return;
                    }
                    ...
                    for(let k = 3; k < psListStartIndex ; k++) { // YE : change condition appStartIndex -> serviceStartIndex
                        const columns = allvalues[k].trim().split(PROC_GROUP_INFO_PATTERN);
