...
(function() {
    ...
    const launcher = {
        ...
        launch: function(options, id, params, next) {
            ...
            async.series([
                ...
                log.silly("launcher#launch()", "err: ", err, ", results:", results);
        ...
        close: function(options, id, params, next) {
            ...
            async.series([
                ...
                log.silly("launcher#close()", "err: ", err, ", results:", results);
        ...
        listRunningApp: function(options, next) {
            ...
            async.series([
                ...
                log.silly("launcher#listRunningApp()", "err:", err, ", results:", results);
                next(err, results[2]);
            });
    ...
    function makeSession(options, next){
        log.info("launch#makeSession()", (options.session ? "already session connected" : "need to make new session"));
