    ...
    const launcher = {
        ...
        listRunningApp: function(options, next) {
            ...
            function _listRunningApp(next) {
                ...
                if (!addr || !returnValue) {
                    return next(errHndl.changeErrMsg("NOT_SUPPORT_RUNNINGLIST"));
                }
