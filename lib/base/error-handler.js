...
(function () {
    const errMsgHdlr = {},
        ...
        ErrMsgMap = {
            ...
            "for category \"/dev1\"" : "Please enable \"Developer options\" on device",

            //applicationmanager
            "Cannot find proper launchPoint" : "This app is not installed app. Please check by ares-install --list",
            "is not running" : "Please check the app is running status by ares-lauch --running",
            ...
            "INVALID_DISPLAY" : "Please use nonnegative integer values or valid value for the \"display\" option",
    ...
    errMsgHdlr.getServiceErrMsg = function(service, errKey, errCode, errText) {
        ...
        // make [service] error with errKey
        const resultErr = [];
        ...
        //     const tipsErr = errMsgHdlr.changeErrMsg(errText);
        //     // // if [tips] message is not defined in common error map, find it in service's errorMessage
        //     // if(tipsErr.message === undefined){
        //     //     tipsErr.message = ErrServiceCodeMap[service][errCode];
        //     // }
