...
(function () {
    const errMsgHdlr = {},
        ErrMsgMap = {
            ...
            "NOT_MATCHED_LOGDAEMON" : "CLI's log daemon should be matched the target's log deamon\nPlease change CLI's log daemon to same as target's log daemon",
            "NOT_MATCHED_LOG" : "There is no logs from the ID\nPlease check the options conbination or the ID",
            ...
            "NOT_EXIST_LOGFILE" : "The log file is not exist in platform",
            ...
            "NOT_SUPPORT_JOURNALD" : "The journald does not support the option",
            "NOT_SUPPORT_PMLOGD" : "The pmlogd does not support the option",
            "NOT_USE_WITH_OPTIONS" : "Do not use together with options",
            "EMPTY_FILENAME" : "Please input log file name from --file-list option",
            "EMPTY_ID" : "Please input a app or service ID",
