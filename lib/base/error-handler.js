...
(function () {
    const errMsgHdlr = {},
        ErrMsgMap = {
            ...
            "invalid parameters" : "Invalid parameters are passed. Please check the parameter format",
    ...
    errMsgHdlr.getErrMsg = function(errKey, option, value, heading) {
        console.log("[getErrMsg][errKey] : "+ errKey, " [option] : " + option + " [value] : " + value + " [heading] : " + heading);
