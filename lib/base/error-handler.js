...
(function () {
    ...
    errMsgHdlr.getErrMsg = function(errKey, option, value, heading) {
        log.silly("errMsgHdlr#getErrMsg()", "errKey:", errKey, ", option:", option, ", value:", value, ", heading:", heading);
    ...
    errMsgHdlr.getErrStr = function(errKey, option, value) {
        log.silly("errMsgHdlr#getErrStr()", "errKey:", errKey, ", option:", option, ", value:", value);
