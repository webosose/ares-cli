...
(function () {
    const errMsgHdlr = {},
        ErrMsgMap = {
            ...
            "NOT_ACTIVE_LOGDAEMON" : "The current log daemon is not active in target device\nPlease change CLI's current log daemon to same as target device by ares-log -sd option",
            "NOT_DIRTYPE_PATH" : "The specified path is not a directory",
            "NOT_EXIST_PATH" : "The specified path does not exist",
            "NOT_EXIST_DAEMONNAME" : "The specified daemon does not exist",
            ...
            "NOT_SUPPORT_JOURNALD" : "Journal daemon does not support the option",
            "NOT_SUPPORT_PMLOGD" : "Pmlog daemon does not support the option",
